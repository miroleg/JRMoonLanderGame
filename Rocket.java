...
import com.javarush.games.moonlander.RocketFire;
import java.util.*;
...
public class Rocket extends GameObject {
    ...
    List<int[][]> downList = new ArrayList<int[][]>(Arrays.asList(ShapeMatrix.FIRE_DOWN_1,
    ShapeMatrix.FIRE_DOWN_2,ShapeMatrix.FIRE_DOWN_3));
    
    List<int[][]> leftrightList = new ArrayList<int[][]>(Arrays.asList(ShapeMatrix.FIRE_SIDE_1,
    ShapeMatrix.FIRE_SIDE_2));
   
    public Rocket(double x, double y) {
        super(x, y, ShapeMatrix.ROCKET);
        this.downFire = new RocketFire(downList);
        this.leftFire = new RocketFire(leftrightList);
        this.rightFire = new RocketFire(leftrightList);
    }
